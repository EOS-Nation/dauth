...
func cutoffLua() (*asset, error) {
	...
	info := bindataFileInfo{name: "cutoff.lua", size: 3435, mode: os.FileMode(420), modTime: time.Unix(1616074600, 0)}
